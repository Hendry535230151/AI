...
const fileController = {
    getAllFiles: async (req, res) => {
        try {
            ...
            res.status(err.statusCode || 400).json({ success: false, message: err.message || 'Failed to fetch files' });
        }
    },
    ...
    getFileByName: async (req, res) => {
        ...
        try {
            ...
            res.status(err.statusCode || 400).json({ success: false, message: err.message || 'Failed to fetch file by name' });
        }
    },
    ...
    getFileById: async (req, res) => {
        ...
        try {
            ...
            res.status(err.statusCode || 400).json({ success: false, message: err.message || 'Failed to fetch file by ID' });
        }
    },
    ...
    renameFile: async (req, res) => {
        ...
        try {
            ...
            res.status(err.statusCode || 400).json({ success: false, message: err.message || 'Failed to rename file' });
        }
    },
    ...
    deleteFileById: async (req, res) => {
        ...
        try {
            ...
            res.status(200).json({ success: true, message: 'File deleted successfully', data: deletedFile });
        } catch (err) {
