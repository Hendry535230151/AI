    ...
    <div className={styles.setting_wrapper}>
      <div className={styles.setting_card}>
          ...
          <div className={styles.setting_selection}>
            <ul className={styles.setting_group}>
              <li
                ...
                className={
                  isActiveSetting === "basic" ? styles.setting_active : ""
                }
              >
                Basic Setting
              </li>
              <li
                ...
                className={
                  isActiveSetting === "theme" ? styles.setting_active : ""
                }
              >
                Theme Setting
              </li>
              <li
                ...
                className={
                  isActiveSetting === "clear" ? styles.setting_active : ""
                }
              >
                Clear Setting
              </li>
        ...
        <div className={styles.setting_content}>
          {isActiveSetting === "basic" && (
            <ChangeProfile userId={user.id}></ChangeProfile>
          )}
          {isActiveSetting === "theme" && (
            <ChangeTheme
              setIsDarkMode={setIsDarkMode}
              updateTheme={updateTheme}
            />
          )}
          {isActiveSetting === "clear" && (
            <ClearSetting
